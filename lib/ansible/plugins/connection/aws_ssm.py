...
class Connection(ConnectionBase):
    ...
    def get_url(self, client_method, bucket_name, out_path, http_method):
    ...
    def _file_transport_command(self, in_path, out_path, ssm_action):
        ...
        put_command = 'curl --request PUT --upload-file %s "%s"' % (in_path, self.get_url('put_object', self.get_option('bucket_name'), out_path, 'PUT'))
        get_command = 'curl -v "%s" -o %s' % (self.get_url('get_object', self.get_option('bucket_name'), out_path, 'GET'), out_path)
